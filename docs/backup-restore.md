...
`/console/recovery` では、最後の restore drill、次回 drill 期限、reminder window、maintenance 状態も確認できます。
...
nightly maintenance は restore drill の reminder を自動で残し、期限が近いときに ops へ知らせます。
...
2. backup snapshots、restore drill の履歴、次回期限を確認する
